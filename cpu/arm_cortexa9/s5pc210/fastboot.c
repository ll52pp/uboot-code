...
#elif defined(CONFIG_S5PV310) || defined(CONFIG_S5PC210)
	writel(0x1f80, S5P_OTG_PHYPWR);
	writel(0x5, S5P_OTG_PHYCLK);/////ly
#else
#error "* CFG_ERROR : you have to select proper CPU for Android Fastboot"
#endif
...
#if defined(CONFIG_S5PC110)||defined(CONFIG_S5PV310) || defined(CONFIG_S5PC210)
...
#if defined(CONFIG_SMDKC210)
	device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "smdkc210";
#elif defined(CONFIG_SMDKV310)
	device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "smdkv310";
#else
